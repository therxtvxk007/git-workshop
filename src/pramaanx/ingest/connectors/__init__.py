"""Connectors shipped through Phase 1B.
...
Importing this package registers all implemented connectors. The remaining Tier-0 and
Tier-1 sources in the build plan (ReliefWeb, data.gov.in, Bluesky,
...
__all__ = ["AcledConnector", "GdeltConnector", "SyntheticConnector"]
